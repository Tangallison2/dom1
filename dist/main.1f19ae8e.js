...
dom.on(test3, 'click', function () {
  console.log('点击了');
});
dom.off(test3, 'click', function () {
  console.log('点击了');
});
var testDiv = dom.find('#haha')[0];
console.log(testDiv);
var test4 = dom.find('.red', testDiv)[1];
console.log(test4);
...
dom.each(dom.children(t), function (a) {
  return dom.style(a, 'color', 'red');
});
